package com.stech.spring_opencsv;
...
public class SpringOpencsvApplication implements CommandLineRunner {

	@Autowired
	EmployeeRepository employeeRepository;

	public static void main(String[] args) {
		SpringApplication.run(SpringOpencsvApplication.class, args);
	}
